            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                <div className="relative mb-6">
                  ...
                  {/* Platform Logo Badge */}
                  <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-10 h-10 bg-green-500 rounded-full flex items-center justify-center border-4 border-black">
                    <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor">
